$(document).ready(function () {
    ...
    var movieTypeName = getUrlParam("typeName");
    $("#movieTypeName").html(movieTypeName+" <span>电影</span>");
    ...
    function getMoviesByGenre(movieType) {
        var to = dappAddress;
        var value = "0";
        var callFunction = "getMoviesByGenre";
        var callArgs = [];
        callArgs.push(movieType);
        callArgs.push("1");
        callArgs.push("10");
